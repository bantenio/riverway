    ...
    public static NodeComponent proxy2NodeComponent(Object bean, String nodeId) {
        try {
            ...
            if (ObjectUtil.isNotNull(liteflowCmpDefine)) {
                ...
                NodeComponent nodeComponent = (NodeComponent) proxy.getProxy();
            ...
            if (ObjectUtil.isNotNull(liteflowSwitchCmpDefine)) {
                ...
                NodeSwitchComponent nodeSwitchComponent = (NodeSwitchComponent) proxy.getProxy();
                nodeSwitchComponent.setType(NodeTypeEnum.SWITCH);
