package com.yomahub.liteflow.builder.gyf.operator.ext
...
class LogNodeAround implements NodeAround {
    ...
    LogNodeAround(String message, Object[] args, Level level) {
    ...
    @Override
    void before(NodeCondition nodeCondition, Node node, Slot slot) throws Throwable {
