package com.yomahub.liteflow.example.context;

import com.yomahub.liteflow.example.buffer.Buffer;
import com.yomahub.liteflow.example.lang.Copyable;
...
public class DataArray implements Iterable<Object>, Copyable {
    ...
    public String getString(int pos) {
        ...
        if (val instanceof Instant) {
            ...
            return DataObject.BASE64_ENCODER.encodeToString((byte[]) val);
        } else if (val instanceof Buffer) {
            return DataObject.BASE64_ENCODER.encodeToString(((Buffer) val).getBytes());
    ...
    public byte[] getBinary(int pos) {
        ...
        return DataObject.BASE64_DECODER.decode(encoded);
    }
    ...
    public Buffer getBuffer(int pos) {
        ...
        String encoded = (String) val;
        // parse to proper type
        return Buffer.buffer(DataObject.BASE64_DECODER.decode(encoded));
    }
    ...
    public Object getValue(int pos) {
        return DataObject.wrapJsonValue(list.get(pos));
    }
    ...
    public boolean remove(Object value) {
        final Object wrappedValue = DataObject.wrapJsonValue(value);
    ...
    public Object remove(int pos) {
        return DataObject.wrapJsonValue(list.remove(pos));
    }
    ...
    public DataArray copy() {
        ...
        for (Object val : list) {
            copiedList.add(DataObject.checkAndCopy(val));
        }
    ...
    private static class Iter implements Iterator<Object> {
        ...
        @Override
        public Object next() {
            return DataObject.wrapJsonValue(listIter.next());
        }
